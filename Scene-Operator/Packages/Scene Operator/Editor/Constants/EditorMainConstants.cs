namespace SceneOperator.Editor.Constants
{
    public static class EditorMainConstants
    {
        ...
        public const string SIGNATURE_PREFIX_LABEL = "by";
        public const string SIGNATURE_POSTFIX_LABEL = "Kyoto";
    }
}